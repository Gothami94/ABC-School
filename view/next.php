          ...
          <h3>Edit Student</h3>
            ...
            <form method="post" action="../controller/edit.php" name="addStudent">
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="address" name="address" value="<?php echo $results['address']; ?>">
                   </div>
                   <div class="form-group">
                      <label>Email</label><br>
                      <input type="text" class="form-control" id="email" name="email" value="<?php echo $results['email']; ?>">
                   </div>
                   <div class="form-group">
                      <label>Telephone</label><br>
                      <input type="text" class="form-control" id="tele" name="tele" value="<?php echo $results['tele']; ?>">
                   </div>
